...
export default function Column({ status, tasks, onEditTask, onDeleteTask }) {
  ...
  return (
    <div className="w-full">
      <div className={`${statusConfig.columnColor} rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg glass-effect animate-fade-in ${isOver ? 'ring-4 ring-blue-400 ring-opacity-50' : ''}`}>
        {/* 列ヘッダー */}
        ...
        >
          ...
          >
            {tasks.length === 0 ? (
              <div className="absolute inset-0 flex items-center justify-center text-center text-gray-500 text-sm font-medium">
